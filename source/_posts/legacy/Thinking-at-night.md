...
{% note info %}
同步發布於 [巴哈姆特](https://forum.gamer.com.tw/C.php?bsn=4918&snA=29415&tnum=1)
{% endnote %}

# 遊戲介紹

![Thinking at night 封面圖](https://i.imgur.com/zPMiv63.png)
...
**【遊玩時間】** 約 60 分鐘
**【素材來源】** 全自製
**【下載連結】** [itch.io](https://tinytsunami.itch.io/thinking-at-night)
...
{% note success %}
更新紀錄提供給大家參考，目前的最新版是 [v1.3 版](#v1-3-版)
{% endnote %}
...
![圖 1、躲怪遊戲的路燈（事件出沒）](https://i.imgur.com/9BEVNRn.jpg)
![圖 2、結界路燈的形象圖](https://i.imgur.com/8qC0WRT.png)
...
![圖 3、LB302 的樂器插件](https://i.imgur.com/lFw2BGR.png)
...
![圖 4、《Ending Mix》樂曲軌道](https://i.imgur.com/7Sup7TK.jpg)
...
![圖 5、主圖的設計草稿](https://i.imgur.com/Pk74d03.jpg)
...
![圖 6、自己測試的成績紀錄手稿（最初版）](https://i.imgur.com/BoPh5Zq.jpg)

## 製作後續

{% note info %}
這個音樂遊戲的插件請參考 {% permalink rpg-maker-mv-music-game %}
{% endnote %}
