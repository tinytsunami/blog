...
categories: 
    - "system"
date: 2026-03-24 22:57:00
updated: 2026-03-27 02:02:00
mathjax: false
source: notion
---
...
- Since any change in Notion updates the `last_edited_time`, I treat all changes as `updated`. So:
    - Do nothing if it’s not updated.
    - If `!in_trash && !archived && updated`, remove the existing file (if any) and generate a new one.
